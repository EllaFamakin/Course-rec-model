...
major_course_map = {
    ...
    "Data Science": {
        ...
        "CS Requirements": ["CSCI 110", "CSCI 120", "CSCI 241", "CSCI 312", "CSCI 380", "CSCI 210", "CSCI 310", "CSCI 411", "CSCI 412"],
    },
    "Mathematics":{
        "Core:": ["CORE 100", "CORE 150", "CORE 160", "CORE 120", "CORE 201", "CORE 260", "CORE 360"],
        "Cognates": ["CSCI 110", "CSCI 120", "NSCI 360", "PHYS 130"],
        "Major Requirements": ["MATH 120", "MATH 130", "MATH 210", "MATH 220", "MATH 240", "MATH 270", "MATH 320", "MATH 353", "MATH 395"]
    }
}
...
def find_majors_and_types(Course_code):
    ...
    for major, categories in major_course_map.items():
        for req_type, course_list in categories.items():
            ...
            if any(Course_code.startswith(c.split()[0]) and c.split()[1] in Course_code for c in course_list):
                applicable.append(major)
                requirement_type.append(req_type)
    if not applicable:
        applicable = ["OTHER"]
        requirement_type = ["General Elective"]
